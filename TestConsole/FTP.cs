...
namespace TestConsole
{
    public class FTP
    {
        ...
        public void Download(string remoteFile, string localFile)
        {
            try
            {
                string remoteFilePath =  host + "/" + remoteFile;
        ...
        public void Upload(string remoteFile, string localFile)
        {
            try
            {
                ...
                if (bytesSent == 0)
                {
                    Console.WriteLine("Upload File size is Empty !");
                }
                ...
                try
                {
                    while (bytesSent != 0)
                    {
                        ...
                        Console.WriteLine(" ***** bytesSent siez = " + bytesSent);
                    }
                }
                catch (Exception ex)
                {
                    Console.WriteLine(" ***-1** file siez = ");
